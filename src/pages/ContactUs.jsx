    ...
    <>
      ...
      <div className="pt-[3rem]">
        <div className="wrapper">
                  <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5 max-w-4xl mx-auto mb-[3rem]">
          <div
            data-aos="fade-up"
          ...
          <Link
            to={`https://wa.me/${companyDetails.whatsapp.replace('+', '')}`}
            target="_blank"
            rel="noopener noreferrer"
            data-aos="fade-up"
            className="bg-primary/5 flex flex-col gap-3 text-primary items-center justify-center rounded-xl p-5 hover:bg-primary/10 transition-colors"
          >
            <MessageCircle strokeWidth={2} size={40} className="inline" />
            <span className="text-center font-medium">
              WhatsApp
            </span>
          </Link>
