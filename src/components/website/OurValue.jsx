      ...
      <div className="wrapper grid md:grid-cols-2 items-center gap-7">
        <div className="flex flex-col items-start gap-5">
          ...
          <p data-aos="fade-up" className="desc">
            Our diverse expertise spans web development domains, enabling businesses of
            all sizes to harness cutting-edge technologies across Custom Website Development, 
            and UI/UX design.
          </p>
        ...
        >
          <div className="flex flex-col gap-2">
            <div className="flex justify-between gap-4">
              <p className="">Custom Website Development</p>
              <p className="">95%</p>
            </div>
          ...
          <div className="flex flex-col gap-2">
            <div className="flex justify-between gap-4">
              <p className="">Performance Optimization</p>
              <p className="">90%</p>
            </div>
            <div className="w-full bg-white h-2 rounded-full overflow-hidden">
